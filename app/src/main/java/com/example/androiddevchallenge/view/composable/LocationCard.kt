...
@Composable
fun LocationCard(viewModel: WeatherViewModel) {
    Column(
        modifier = Modifier
        ...
        Text(
            text = viewModel.response.value.name,
            color = MaterialTheme.colors.onSecondary,
            style = typography.h5,
        ...
        Row(
            ...
            Text(
                text = (viewModel.response.value.coord.lat).toInt()
                    .toString(),
                color = MaterialTheme.colors.onSecondary,
            ...
            Text(
                text = (viewModel.response.value.coord.lon).toInt()
                    .toString(),
                color = MaterialTheme.colors.onSecondary,
                style = typography.subtitle2,
                modifier = Modifier.padding(8.dp)
